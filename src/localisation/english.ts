...
const ENGLISH: Translations = {
  ...
  [Phrase.StoragePathDescription]: 'Location to store the recordings. XIV Recorder takes ownership of this directory, it should be empty on initial setup and you should not modify the contents in-place.',
  ...
  [Phrase.RetailLogPathDescription]: 'Location of the IINACT log directory, e.g. "C:\\Users\\YourName\\Documents\\IINACT".',
  [Phrase.ClassicLogPathDescription]: 'Unused.',
  [Phrase.ClassicPtrLogPathDescription]: 'Unused.',
  [Phrase.EraLogPathDescription]: 'Unused.',
  ...
  [Phrase.ObsOutputResolutionDescription]: 'Resolution of videos as saved on disk. Set this to the size of your FFXIV monitor, or less if you want to scale down.',
  ...
  [Phrase.RecordRetailDescription]: 'Whether to automatically record Crystalline Conflict matches.',
  ...
  [Phrase.RecordFiveVFiveDescription]: 'Unused.',
  [Phrase.RecordSkirmishDescription]: 'Unused.',
  [Phrase.RecordSoloShuffleDescription]: 'Unused.',
  [Phrase.RecordBattlegroundsDescription]: 'Unused.',
  [Phrase.CaptureCursorDescription]: 'Whether the cursor should be included in recordings.',
  [Phrase.MinKeystoneLevelDescription]: 'Unused.',
  [Phrase.ChallengeModeDescription]: 'Unused.',
  [Phrase.MinRaidDifficultyDescription]: 'Unused.',
  ...
  [Phrase.RaidOverrunDescription]: 'Unused.',
  [Phrase.DungeonOverrunDescription]: 'Unused.',
  ...
  [Phrase.CloudUploadRetailDescription]: 'Unused.',
  [Phrase.CloudUploadClassicDescription]: 'Unused.',
  ...
  [Phrase.CloudAccountNameDescription]: 'Your XIV Recorder account username. This will be shown as your display name when using the chat feature.',
  [Phrase.CloudAccountPasswordDescription]: 'Your XIV Recorder account password.',
  [Phrase.CloudGuildNameDescription]: 'The guild or group your account is affiliated with.',
  [Phrase.CloudUpload2v2Description]: 'Unused.',
  [Phrase.CloudUpload3v3Description]: 'Unused.',
  [Phrase.CloudUpload5v5Description]: 'Unused.',
  [Phrase.CloudUploadSkirmishDescription]: 'Unused.',
  [Phrase.CloudUploadSoloShuffleDescription]: 'Unused.',
  [Phrase.CloudUploadDungeonsDescription]: 'Unused.',
  [Phrase.CloudUploadRaidsDescription]: 'Unused.',
  [Phrase.CloudUploadBattlegroundsDescription]: 'Unused.',
  [Phrase.CloudUploadRaidMinDifficultyDescription]: 'Unused.',
  [Phrase.CloudUploadDungeonMinLevelDescription]: 'Unused.',
  ...
  [Phrase.TestButtonUnable]: 'Unable to run a test right now. To run a test, Final Fantasy XIV must be running, your settings must be valid, and you must not currently be in an activity.',
  ...
  [Phrase.RecordRetailLabel]: 'Record Crystalline Conflict',
  [Phrase.RetailLogPathLabel]: 'IINACT Log Path',
  ...
  [Phrase.InvalidRetailLogPathText]: 'Invalid IINACT log path',
  [Phrase.InvalidClassicLogPathText]: 'Unused.',
  [Phrase.InvalidClassicPtrLogPathText]: 'Unused.',
  [Phrase.InvalidClassicEraLogPathText]: 'Unused.',
  ...
  [Phrase.SearchSuggestionMythicPlus]: 'Unused.',
  [Phrase.SearchSuggestionRaid]: 'Unused.',
  [Phrase.SearchSuggestionBattlegrounds]: 'Unused.',
  [Phrase.SearchSuggestionSoloShuffle]: 'Unused.',
  [Phrase.SearchSuggestionDefault]: 'Try: win cloud nine ninja bookmarked',
  ...
  [Phrase.StatusDescriptionRecording]: 'XIV Recorder is currently recording',
  [Phrase.StatusDescriptionForceEnd]: 'You can force the recording to end. Normally this should not be required.',
  [Phrase.StatusDescriptionWaiting]: 'Waiting for Final Fantasy XIV to start',
  [Phrase.StatusDescriptionConfiguredToRecord]: 'XIV Recorder is configured to record',
  [Phrase.StatusDescriptionMisconfigured]: 'XIV Recorder is misconfigured',
  [Phrase.StatusDescriptionResolveError]: 'Please resolve the error below',
  [Phrase.StatusDescriptionDetectedRunning]: 'Detected Final Fantasy XIV is running',
  [Phrase.StatusDescriptionWatchingLogs]: 'XIV Recorder is waiting for a recordable event to appear in the IINACT log. Watching log path',
  ...
  [Phrase.StatusDescriptionFatalError]: 'XIV Recorder has hit a fatal error',
  ...
  [Phrase.StatusDescriptionOverrunning]: 'XIV Recorder has detected an activity has completed and is recording a few seconds extra to catch the aftermath.',
  ...
  [Phrase.CrashHappenedText]: 'An error has occured. This can result in dropped videos. You may wish to seek help by sharing your XIV Recorder and OBS logs in discord.',
  ...
  [Phrase.InvalidRetailLogPath]: 'Invalid IINACT log path.',
  [Phrase.InvalidClassicLogPath]: 'Unused.',
  [Phrase.InvalidClassicPtrLogPath]: 'Unused.',
  [Phrase.InvalidEraLogPath]: 'Unused.',
  ...
  [Phrase.RetailPtrLogPathDescription]: 'Unused.',
  [Phrase.RecordRetailPtrDescription]: 'Unused.',
  [Phrase.RetailPtr]: 'Retail PTR',
  [Phrase.RecordRetailPtrLabel]: 'Record Retail PTR',
  [Phrase.RetailPtrLogPathLabel]: 'Retail PTR Log Path',
  [Phrase.InvalidRetailPtrLogPathText]: 'Unused.',
  ...
  [Phrase.RecordCurrentRaidsOnlyLabel]: "Unused",
  [Phrase.RecordCurrentRaidsOnlyDescription]: "Unused.",
  [Phrase.UploadCurrentRaidsOnlyLabel]: "Unused",
  [Phrase.UploadCurrentRaidsOnlyDescription]: "Unused.",
  ...
  [Phrase.ValidateLogPathsDescription]: 'XIV Recorder checks the IINACT log path points to a valid directory.',
