 ...
 *   - (prod) "C:\Users\alexa\AppData\Roaming\XIVRecorder\config-v3.json"
...
const createWindow = async () => {
  ...
  window = new BrowserWindow({
    ...
    frame: false,
    title: `XIV Recorder v${appVersion}`,
    webPreferences: {
...
/**
 * Listener to open the folder containing the XIV Recorder logs.
 */
